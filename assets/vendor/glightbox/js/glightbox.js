(function (global, factory) {
  ...
  var SlideConfiBuildUparser = function () {
    function SlideConfiBuildUparser() {
      var slideParamas = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      _classCallCheck(this, SlideConfiBuildUparser);
      this.defaults = {
        href: '',
        sizes: '',
        srcset: '',
    ...
    return _createClass(SlideConfiBuildUparser, [{
      key: "sourceType",
  ...
  var Slide = function () {
    ...
    return _createClass(Slide, [{
      ...
      value: function getConfig() {
        ...
        var parser = new SlideConfiBuildUparser(this.instance.settings.slideExtraAttributes);
  ...
  defaults.lightboxHTML = "<div id=\"glightbox-body\" class=\"glightbox-container\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"false\">\n    <div class=\"gloader visible\"></div>\n    <div class=\"goverlay\"></div>\n    <div class=\"gcontainer\">\n    <div id=\"glightbox-slider\" class=\"gslider\"></div>\n    <button class=\"gclose gbtn\" aria-label=\"Close\" data-taborder=\"3\">{closeSVG}</button>\n    <button class=\"BuildUprev gbtn\" aria-label=\"Previous\" data-taborder=\"2\">{prevSVG}</button>\n    <button class=\"gnext gbtn\" aria-label=\"Next\" data-taborder=\"1\">{nextSVG}</button>\n</div>\n</div>";
  var GlightboxInit = function () {
    ...
    return _createClass(GlightboxInit, [{
      ...
      value: function build() {
        ...
        this.prevButton = modal.querySelector('.BuildUprev');
          ...
          this.events['outClose'] = addEvent('click', {
            ...
            withCallback: function withCallback(e, target) {
              if (!_this7.preventOutsideClick && !hasClass(document.body, 'glightbox-mobile') && !closest(e.target, '.ginner-container')) {
                if (!closest(e.target, '.gbtn') && !hasClass(e.target, 'gnext') && !hasClass(e.target, 'BuildUprev')) {
                  _this7.close();
                }
              }
            }
